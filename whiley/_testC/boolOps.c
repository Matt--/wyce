...
bool f_bool1 ( Any , Any );
bool f_bool2 ( Any , Any );
bool f_bool3 ( Any , Any );
bool f_bool4 ( Any , Any );
bool f_bool5 ( Any , Any );
bool f_bool6 ( Any , Any );
bool f_bool7 ( Any , Any );
bool f_bool8 ( Any , Any );
bool f_bool9 ( Any , Any );
bool f_bool10 ( Any , Any );
bool f_bool11 ( Any , Any );
bool f_bool12 ( Any , Any );
bool f_bool13 ( Any , Any );
bool f_bool14 ( Any , Any );
bool f_bool15 ( Any , Any );
bool f_bool16 ( Any , Any );
bool f_bool17 ( Any , Any );
bool f_bool18 ( Any , Any );
bool f_bool19 ( Any , Any );
bool f_bool20 ( Any , Any );
bool f_bool21 ( Any , Any );
bool f_bool22 ( Any , Any );
bool f_bool23 ( Any , Any );
bool f_bool24 ( Any , Any );
bool f_bool25 ( Any , Any );

int main (){
  Any a2 = Bool(true);
  Any a4 = Bool(false);
  Any a6 = Bool(f_bool1 ( a2, a4 ));
  Any a5 = a6;
  Any a12 = a5;
  println ( a12 );
  Any a16 = Bool(f_bool2 ( a2, a4 ));
  println ( a16 );
  Any a22 = Bool(f_bool3 ( a2, a4 ));
  println ( a22 );
  Any a28 = Bool(f_bool4 ( a2, a4 ));
  println ( a28 );
  Any a34 = Bool(f_bool5 ( a2, a4 ));
  println ( a34 );
  Any a40 = Bool(f_bool6 ( a2, a4 ));
  println ( a40 );
  Any a46 = Bool(f_bool7 ( a2, a4 ));
  println ( a46 );
  Any a52 = Bool(f_bool8 ( a2, a4 ));
  println ( a52 );
  Any a58 = Bool(f_bool9 ( a2, a4 ));
  println ( a58 );
  Any a64 = Str("10");
  println ( a64 );
  Any a68 = Bool(f_bool10 ( a2, a4 ));
  println ( a68 );
  Any a74 = Bool(f_bool11 ( a2, a4 ));
  println ( a74 );
  Any a80 = Bool(f_bool12 ( a2, a4 ));
  println ( a80 );
  Any a86 = Bool(f_bool13 ( a2, a4 ));
  println ( a86 );
  Any a92 = Bool(f_bool14 ( a2, a4 ));
  println ( a92 );
  Any a98 = Str("15");
  println ( a98 );
  Any a102 = Bool(f_bool15 ( a2, a4 ));
  println ( a102 );
  Any a108 = Bool(f_bool16 ( a2, a4 ));
  println ( a108 );
  Any a114 = Bool(f_bool17 ( a2, a4 ));
  println ( a114 );
  Any a120 = Bool(f_bool18 ( a2, a4 ));
  println ( a120 );
  Any a126 = Bool(f_bool19 ( a2, a4 ));
  println ( a126 );
  Any a132 = Str("20");
  println ( a132 );
  Any a136 = Bool(f_bool20 ( a2, a4 ));
  println ( a136 );
  Any a142 = Bool(f_bool21 ( a2, a4 ));
  println ( a142 );
  Any a148 = Bool(f_bool22 ( a2, a4 ));
  println ( a148 );
  Any a154 = Bool(f_bool23 ( a2, a4 ));
  println ( a154 );
  Any a160 = Bool(f_bool24 ( a2, a4 ));
  println ( a160 );
  Any a166 = Str("25");
  println ( a166 );
  Any a170 = Bool(f_bool25 ( a2, a4 ));
  println ( a170 );
  return 0;
}

bool f_bool1 ( Any a0, Any a1 ){
